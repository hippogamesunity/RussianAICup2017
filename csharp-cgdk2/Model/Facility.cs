namespace Com.CodeGame.CodeWars2017.DevKit.CSharpCgdk.Model {
    public partial class Facility {
        ...
        private readonly double capturePositions;
        private readonly VehicleType? vehicleType;
        private readonly int productionProgress;

        public Facility(long id, FacilityType type, long ownerPlayerId, double left, double top, double capturePositions,
            ...
            this.left = left;
            this.top = top;
            this.capturePositions = capturePositions;
        ...
        public double CapturePositions => capturePositions;
